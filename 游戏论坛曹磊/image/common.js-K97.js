...
function initSearchmenu(searchform, cloudSearchUrl) {
	var defaultUrl = 'http://dtws.netease.com/static/js/search.php?searchsubmit=yes';
...
function patchNotice() {
	if($('patch_notice')) {
		ajaxget('http://dtws.netease.com/static/js/misc.php?mod=patch&action=patchnotice', 'patch_notice', '');
	}
}

function pluginNotice() {
	if($('plugin_notice')) {
		ajaxget('http://dtws.netease.com/static/js/misc.php?mod=patch&action=pluginnotice', 'plugin_notice', '');
	}
}
