...
function fastpostappendreply() {
	if($('fastpostrefresh') != null) {
		...
		if($('fastpostrefresh').checked) {
			location.href = 'http://dtws.netease.com/static/js/forum.php?mod=redirect&tid='+tid+'&goto=lastpost&random=' + Math.random() + '#lastpost';
			return;
		}
	}
...
function submitpostpw(pid, tid) {
	...
	safescript('md5_js', function () {
		...
		if(!tid) {
			...
			location.href = 'http://dtws.netease.com/static/js/forum.php?mod=viewthread&tid='+tid;
		}
	}, 100, 50);
}
...
function vmessage() {
	...
	$('vreplysubmit').onmouseover = function() {
		if($('vmessage').value != vf_tips) {
			ajaxget('http://dtws.netease.com/static/js/forum.php?mod=ajax&action=checkpostrule&ac=reply', 'vfastpostseccheck');
