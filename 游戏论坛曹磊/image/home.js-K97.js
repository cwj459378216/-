		...
		theImages[i].onload = function() {
			if (this.width > size) {
				...
				if (this.parentNode.tagName.toLowerCase() != 'a') {
					...
					zoom.src = 'zoom.gif'/*tpa=http://dtws.netease.com/static/js/image/zoom.gif*/;
					...
					zoomDiv.onmouseover = function() {
						zoom.src = 'zoom_h.gif'/*tpa=http://dtws.netease.com/static/js/image/zoom_h.gif*/;
					};
...
function showFlash(host, flashvar, obj, shareid) {
	var flashAddr = {
		'http://dtws.netease.com/static/js/youku.com' : 'fi000001.swf-videoids=xma==&embedid=-&wd=&wintype=bdskin&cna=mteumtczlje5ny4xmzuxndkxmtq4mzayotg5mw==&partnerid=0edbfd2e4fc91b72&vext=pid=0edbfd2e4fc91b72&emb=-&bc=&cna=mteumtczlje5ny4xmzuxndkxmtq4mzayotg5mw==&vvlogext=pc_i%3d1491148302010smm%26pc_u%3d-%26rvpvid%3d-%26rycid%3d-%26yvft%3d1491148302000%26vsidc%3d1%26seid%3d1491148302010hqy%26vstp%3d1%26svstp%3d1&type=0&embsig=1_1491148302_38093a6a0705efc0c4a81ced68197056'/*tpa=http://player.youku.com/player.php/sid/FLASHVAR=/v.swf*/,
		'v-1.swf' : 'v-1.swf'/*tpa=http://player.ku6.com/refer/FLASHVAR/v.swf*/,
		'http://dtws.netease.com/static/js/youtube.com' : 'http://www.youtube.com/v/FLASHVAR',
		'http://dtws.netease.com/static/js/5show.com' : 'http://www.5show.com/swf/5show_player.swf?flv_id=FLASHVAR',
		'http://dtws.netease.com/static/js/sina.com.cn' : 'http://vhead.blog.sina.com.cn/player/outer_player.swf?vid=FLASHVAR',
		'http://dtws.netease.com/static/js/sohu.com' : 'http://v.blog.sohu.com/fo/v4/FLASHVAR',
		'http://dtws.netease.com/static/js/mofile.com' : 'http://tv.mofile.com/cn/xplayer.swf?v=FLASHVAR',
		'music' : 'FLASHVAR',
		'flash' : 'FLASHVAR'
	};
...
function userapp_open() {
	var x = new Ajax();
	x.get('http://dtws.netease.com/static/js/home.php?mod=spacecp&ac=common&op=getuserapp&inajax=1', function(s){
...
function userapp_close() {
	var x = new Ajax();
	x.get('http://dtws.netease.com/static/js/home.php?mod=spacecp&ac=common&op=getuserapp&subop=off&inajax=1', function(s){
		$('my_userapp').innerHTML = s;
...
function showreward() {
	...
	var x = new Ajax();
	x.get('http://dtws.netease.com/static/js/home.php?mod=misc&ac=ajax&op=getreward', function(s){
		if(s) {
			msgwin(s, 2000);
		}
	});
...
function post_add(pid, result) {
	if(result) {
		...
		var x = new Ajax();
		x.get('http://dtws.netease.com/static/js/home.php?mod=misc&ac=ajax&op=post', function(s){
			newli.innerHTML = s;
		});
...
function searchpostbyusername(keyword, srchuname) {
	window.location.href = 'http://dtws.netease.com/static/js/search.php?mod=forum&srchtxt=' + keyword + '&srchuname=' + srchuname + '&searchsubmit=yes';
}

function removeVisitor(event, uid) {
	window.location = 'http://dtws.netease.com/static/js/home.php?mod=space&uid='+uid+'&do=index&view=admin&additional=removevlog';
